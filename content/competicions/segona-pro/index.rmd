...
table <- readRDS("~/GoogleDrive/Futbol/futstat_tables.rds") %>% filter(league == 'primera_division_b_femenina_1') %>% left_join(teamnames, by = "team") %>% arrange(rank) %>% mutate(league = str_sub(league,1,-3))
