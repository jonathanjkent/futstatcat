...
kable(table, digits = 1, align = 'lccccc', row.names = FALSE, col.names = c('Club', 'Elo', '1a', '2a', '3a', '4a')) %>% add_header_above(c('Projecció de la Classificació 2021' = 2, 'Probabilitat (%)' = 4)) %>% column_spec(1, bold = T) %>% column_spec(2, border_right = T)
```
