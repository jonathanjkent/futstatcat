...
image:
  preview_only: true
summary: Projecció de 2022-2023 de Grup III
tags:
  - Futbol Masculí
  - Competicions
title: Segona RFEF
...
kable(table, digits = 1, align = 'lccccccccc', row.names = FALSE, col.names = c('Club','Forma', 'Class.', 'Punts', 'Ascens Dir.', 'Playoff', 'Descens', 'F', 'C', 'Qual.')) %>% add_header_above(c('Temporada' = 4, 'Probabilitat (%)' = 3, 'xGols' = 3)) %>% column_spec(1, bold = T) %>% column_spec(4, border_right = T) %>% column_spec(7, border_right = T)
```
