...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(team == '/Escola-Futbol-Mataro-Cd')
...
games <- games %>% filter(team1 == '/Escola-Futbol-Mataro-Cd' | team2 == '/Escola-Futbol-Mataro-Cd')
