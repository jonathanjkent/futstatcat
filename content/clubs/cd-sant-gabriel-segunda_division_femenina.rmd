...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Cd-San-Gabriel-Femenino')
...
games <- games %>% filter(team1 == '/Cd-San-Gabriel-Femenino' | team2 == '/Cd-San-Gabriel-Femenino')
