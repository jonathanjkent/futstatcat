...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Europa-Femenino')
...
games <- games %>% filter(team1 == '/Europa-Femenino' | team2 == '/Europa-Femenino')
