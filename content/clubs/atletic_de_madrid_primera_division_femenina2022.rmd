...
if (nrow(traj) > 2){
  table <- read.csv('~/Google Drive/Futbol/futstat_tables.csv') %>% filter(league == 'primera_division_femenina2022_1')
  league <- read.csv('~/Google Drive/Futbol/ligas.csv') %>% filter(league == 'primera_division_femenina2022' & group == 1)
