...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Cf-Igualada-Femenino')
...
games <- games %>% filter(team1 == '/Cf-Igualada-Femenino' | team2 == '/Cf-Igualada-Femenino')
