...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Fc-Santfeliuenc')
...
games <- games %>% filter(team1 == '/Fc-Santfeliuenc' | team2 == '/Fc-Santfeliuenc')
