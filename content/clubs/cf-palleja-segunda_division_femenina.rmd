...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Palleja-A-Femenino')
...
games <- games %>% filter(team1 == '/Palleja-A-Femenino' | team2 == '/Palleja-A-Femenino')
