...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Athletic-Club-Femenino')
...
games <- games %>% filter(team1 == '/Athletic-Club-Femenino' | team2 == '/Athletic-Club-Femenino')
