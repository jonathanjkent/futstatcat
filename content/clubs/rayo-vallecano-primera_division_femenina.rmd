...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Rayo-Vallecano-Femenino')
...
games <- games %>% filter(team1 == '/Rayo-Vallecano-Femenino' | team2 == '/Rayo-Vallecano-Femenino')
