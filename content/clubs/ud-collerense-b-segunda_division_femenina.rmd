...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Collerense-B-Femenino')
...
games <- games %>% filter(team1 == '/Collerense-B-Femenino' | team2 == '/Collerense-B-Femenino')
