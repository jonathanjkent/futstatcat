...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Girona-Fc-Femenino')
...
games <- games %>% filter(team1 == '/Girona-Fc-Femenino' | team2 == '/Girona-Fc-Femenino')
