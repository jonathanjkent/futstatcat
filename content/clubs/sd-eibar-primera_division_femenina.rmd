...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Eibar-Femenino')
...
games <- games %>% filter(team1 == '/Eibar-Femenino' | team2 == '/Eibar-Femenino')
