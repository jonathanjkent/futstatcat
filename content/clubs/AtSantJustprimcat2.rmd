...
subtitle: "Primera Catalana, Grup II"
summary: "Primera Catalana, Grup II"
---
...
p <- ggplot(data=prog) + geom_line(aes(round,points, color = team), size = 2)
p + theme_minimal() + labs(color = "", x = "", y = "")
```
