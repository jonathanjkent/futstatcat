...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Sd-Huesca-Femenino')
...
games <- games %>% filter(team1 == '/Sd-Huesca-Femenino' | team2 == '/Sd-Huesca-Femenino')
