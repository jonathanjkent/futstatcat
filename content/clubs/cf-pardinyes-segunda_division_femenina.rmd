...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Pardinyes-Femenino')
...
games <- games %>% filter(team1 == '/Pardinyes-Femenino' | team2 == '/Pardinyes-Femenino')
