...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Son-Sardina-Femenino')
...
games <- games %>% filter(team1 == '/Son-Sardina-Femenino' | team2 == '/Son-Sardina-Femenino')
