...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Ua-Horta-Senior')
...
games <- games %>% filter(team1 == '/Ua-Horta-Senior' | team2 == '/Ua-Horta-Senior')
