...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Fundacio-Terrassa-Futbol-Club-1906-A-Femenina')
...
games <- games %>% filter(team1 == '/Fundacio-Terrassa-Futbol-Club-1906-A-Femenina' | team2 == '/Fundacio-Terrassa-Futbol-Club-1906-A-Femenina')
