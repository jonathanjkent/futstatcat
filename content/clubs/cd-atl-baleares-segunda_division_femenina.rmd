...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Balears-Femenina')
...
games <- games %>% filter(team1 == '/Balears-Femenina' | team2 == '/Balears-Femenina')
