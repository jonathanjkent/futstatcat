...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Levante-Las-Planas-Femenino')
...
games <- games %>% filter(team1 == '/Levante-Las-Planas-Femenino' | team2 == '/Levante-Las-Planas-Femenino')
