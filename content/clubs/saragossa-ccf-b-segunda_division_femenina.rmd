...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Zaragoza-Cf-B-Femenino')
...
games <- games %>% filter(team1 == '/Zaragoza-Cf-B-Femenino' | team2 == '/Zaragoza-Cf-B-Femenino')
