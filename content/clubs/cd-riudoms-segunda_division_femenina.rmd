...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Riudoms-Cd-A-Femenina')
...
games <- games %>% filter(team1 == '/Riudoms-Cd-A-Femenina' | team2 == '/Riudoms-Cd-A-Femenina')
