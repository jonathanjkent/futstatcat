...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Cerdanyola-Valles-Fc')
...
games <- games %>% filter(team1 == '/Cerdanyola-Valles-Fc' | team2 == '/Cerdanyola-Valles-Fc')
