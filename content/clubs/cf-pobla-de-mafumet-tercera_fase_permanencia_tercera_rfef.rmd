...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(league != 'tercera' & team == '/Pobla-Mafumet')
...
games <- games %>% filter(team1 == '/Pobla-Mafumet' | team2 == '/Pobla-Mafumet')
