...
date: "2020-06-17"
title: "Sant Cugat FC"
subtitle: 'Primera Catalana, Grup 1B'
summary: 'Primera Catalana, Grup 1B'
---
### Trajectòria
```{r fig.width=8, fig.height=5, echo=F,warning=FALSE,message=FALSE}
suppressMessages(library(dplyr))
suppressMessages(library(ggplot2))
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(team == '/Sant-Cugat-Esport-Fc-Senior')
h <- read.csv('~/Google Drive/Futbol/data_tables.csv') %>% filter(league == 'primera_catalana_2')
...
games <- games %>% filter(team1 == '/Sant-Cugat-Esport-Fc-Senior' | team2 == '/Sant-Cugat-Esport-Fc-Senior')
