...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(team == '/Ue-Castelldefels')
h <- read.csv('~/Google Drive/Futbol/data_tables.csv') %>% filter(league == 'tercera_4')
...
games <- games %>% filter(team1 == '/Ue-Castelldefels' | team2 == '/Ue-Castelldefels')
