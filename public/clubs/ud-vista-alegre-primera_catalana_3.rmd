...
subtitle: 'Primera Catalana, Grup 2A'
summary: 'Primera Catalana, Grup 2A'
---
### Trajectòria
```{r fig.width=8, fig.height=5, echo=F,warning=FALSE,message=FALSE}
suppressMessages(library(dplyr))
suppressMessages(library(ggplot2))
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(team == '/Ud-Vista-Alegre-Senior')
h <- read.csv('~/Google Drive/Futbol/data_tables.csv') %>% filter(league == 'primera_catalana_3')
...
games <- games %>% filter(team1 == '/Ud-Vista-Alegre-Senior' | team2 == '/Ud-Vista-Alegre-Senior')
