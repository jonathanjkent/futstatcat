...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(team == '/Ue-Jonquera-Senior')
...
games <- games %>% filter(team1 == '/Ue-Jonquera-Senior' | team2 == '/Ue-Jonquera-Senior')
