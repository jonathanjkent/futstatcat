...
subtitle: 'Primera Catalana, Grup 1A'
summary: 'Primera Catalana, Grup 1A'
---
### Trajectòria
```{r fig.width=8, fig.height=5, echo=F,warning=FALSE,message=FALSE}
suppressMessages(library(dplyr))
suppressMessages(library(ggplot2))
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(team == '/Vic-Riuprimer-Refo-Fc')
...
games <- games %>% filter(team1 == '/Vic-Riuprimer-Refo-Fc' | team2 == '/Vic-Riuprimer-Refo-Fc')
