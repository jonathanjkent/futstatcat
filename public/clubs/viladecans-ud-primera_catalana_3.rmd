...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(team == '/Ud-Viladecans-Senior')
...
games <- games %>% filter(team1 == '/Ud-Viladecans-Senior' | team2 == '/Ud-Viladecans-Senior')
