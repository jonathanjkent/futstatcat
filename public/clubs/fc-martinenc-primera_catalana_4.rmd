...
d <- read.csv('~/Google Drive/Futbol/data_trajectories.csv') %>% filter(team == '/Fc-Martinenc-Senior')
...
games <- games %>% filter(team1 == '/Fc-Martinenc-Senior' | team2 == '/Fc-Martinenc-Senior')
